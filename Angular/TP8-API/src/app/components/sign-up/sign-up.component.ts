...
import { map, catchError } from 'rxjs/operators'; //para usar el map y catcherror
  ...
  ngOnInit() {
    ...
    this.userForm = new FormGroup({
      ...
      'password': new FormControl(this.user.password,
        [Validators.required, Validators.minLength(6)]) // validaciones sincronicas: no necesitamos consultar ninguna fuente externa
    });
